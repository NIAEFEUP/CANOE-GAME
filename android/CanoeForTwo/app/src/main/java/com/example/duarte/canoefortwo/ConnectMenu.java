...
public class ConnectMenu extends ActionBarActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        connectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Log.v(this.getClass().getName(), ipInputField.getText().toString());
                //TODO Acrescentar throw quando ele já está ligado e se tenta ligar outra vez
                singleton.state = Singleton.State.CONNECTED;
